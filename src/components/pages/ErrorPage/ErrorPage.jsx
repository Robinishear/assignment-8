...
const ErrorPage = () => {
  ...
  <img 
                ...
                <div role="alert" className="alert alert-error px-15 py-8 mt-4 text-center">
                ...
                <a href="/" className="relative inline-flex items-center justify-center px-10 py-4 overflow-hidden font-mono font-medium tracking-tighter text-white bg-gray-800 rounded-lg group">
                    ...
                    <div className="tooltip">
                        ...
                        <button className="text-2xl font-bold">Home page</button>
                    </div>
                </a>
            </div>
            </div>
